...
public:
	...
	int GoToHomePosition(_tptz__GotoHomePositionResponse &GoToHomePosition, string ProfileToken);
	int GetPresets(_tptz__GetPresetsResponse &GetPresets, string ProfileToken);
	int SetPreset(_tptz__SetPresetResponse &SetPreset, string ProfileToken);
...
inline int OnvifClientPTZ::GoToHomePosition(_tptz__GotoHomePositionResponse &GoToHomePosition, string ProfileToken)
{
	string strUrl;
	string strUser;
	string strPass;
	_tptz__GotoHomePosition	GotoHomePositionReq;
	GotoHomePositionReq.ProfileToken = ProfileToken;
	...
	return ptzProxy.GotoHomePosition(&GotoHomePositionReq, &GoToHomePosition);
}

inline int OnvifClientPTZ::GetPresets(_tptz__GetPresetsResponse &GetPresets, string ProfileToken)
{
	string strUrl;
	string strUser;
	string strPass;
	...
	return ptzProxy.GetPresets(&GetPresetsReq, &GetPresets);
}

inline int OnvifClientPTZ::SetPreset(_tptz__SetPresetResponse &SetPreset, string ProfileToken)
{
	string strUrl;
	string strUser;
	string strPass;
	_tptz__SetPreset SetPresetReq;
	SetPresetReq.ProfileToken = ProfileToken;
	SetPresetReq.PresetName = new string("Name");
	SetPresetReq.PresetToken = new string("Token");
	if (m_Device.GetUserPasswd(strUser, strPass) == false
		|| m_Device.GetPTZUrl(strUrl) == false)
	{
		return SOAP_ERR;
	...
	return ptzProxy.SetPreset(&SetPresetReq, &SetPreset);
}
